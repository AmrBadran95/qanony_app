                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                      image: AssetImage('assets/images/lawyer 1.png'),
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                                ),
                                  ...
                                  children: [
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Text(data["name"],style:AppText.labelSmall,),
                                              Text(data["session"],style:AppText.labelSmall,),
                                              Row(
                                                children: [
                                                  Icon(Icons.assignment_turned_in_outlined,size: MediaQuery.of(context).size.width*.04,),
                                                  Text("رقم الطلب:${data["requestNumber"]}",style:AppText.labelSmall,),
                                        ...
                                        Container(
                                          child:Row(
                                            children: [
                                              Icon(Icons.money_outlined,size: MediaQuery.of(context).size.width*.05,),
                                              SizedBox(width:  MediaQuery.of(context).size.width*.01,),
                                              Text("المبلغ :${data['amount']} ",style: AppText.labelSmall,),
                                              Icon(Icons.attach_money,size: MediaQuery.of(context).size.width*.04,),
                                    ...
                                    Text(
                                      ...
                                      style: AppText.bodySmall.copyWith(
                                        color: data["status"] == "مقبولة - قيد التنفيذ"
                                            ? AppColor.green
                                            : AppColor.primary,
                                      ),
                                    )
