...
import 'package:qanony/services/cubits/lawyer/lawyer_state.dart';
...
class _AccountLawyerScreenState extends State<AccountLawyerScreen> {
  ...
  //   void _selectTime(BuildContext context, [int? indexToEdit]) async {
  //     final DateTime initialDate = indexToEdit != null
  //         ? appointments[indexToEdit]
  //         : selectedDate;
  ...
  //       setState(() {
  //         if (indexToEdit != null) {
  //           appointments[indexToEdit] = updatedDateTime;
  //         } else {
  //           appointments.add(updatedDateTime);
  //         }
  ...
  //     final monthName = DateFormat.MMMM('ar').format(selectedDate);

  //     return Column(
  //       crossAxisAlignment: CrossAxisAlignment.start,
  //       children: [
  //         // شريط العنوان وتحريك الأسبوع
  //         Padding(
  ...
  //         // عرض المواعيد مع أزرار تعديل وحذف
