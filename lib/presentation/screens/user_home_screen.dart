      ...
      body: Column(
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: AssetImage('assets/images/b50.png'),
                  fit: BoxFit.cover,
                ),
              ),
              child: Container(
                    ...
                    Expanded(
                      child: Text(
                        ...
                        style: AppText.bodyMedium.copyWith(
                          color: AppColor.light,fontWeight: FontWeight.bold
          ...
          Padding(
            ...
            child: Text(
              'المحاميون المميزون',
              style: AppText.bodyMedium.copyWith(color: AppColor.dark,fontWeight: FontWeight.bold),
            ),
          ),
          SizedBox(
                height: 200,
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Container(
                            ...
                            child: Column(
                              ...
                              CircleAvatar(
                              radius: 50,
                              backgroundImage: lawyer.profilePictureUrl != null
          ...
          Padding(
            ...
            child: Text(
              'الأسئلة الشائعة',
              style: AppText.bodyLarge.copyWith(color: AppColor.dark,fontWeight: FontWeight.bold),
            ),
          ),
          Expanded(
            child: ListView.builder(
