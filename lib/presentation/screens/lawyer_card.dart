...
import '../../services/showAppointmentBottomSheet/showAppointmentBottomSheet.dart';

class LawyerScreen extends StatelessWidget {
  final String uid;
  const LawyerScreen(this.uid, {super.key});
  @override
  Widget build(BuildContext context) {

    return BlocProvider(
        create: (_) => LawyerCubit(LawyerRepository())..getLawyer(uid),
        child:  Scaffold(
            appBar: AppBar(
                                      ...
                                      CustomButton(
                                        ...
                                        onTap: () {
                                          showAppointmentBottomSheet(
                                            context: context,
                                            appointments: lawyer.availableAppointments,
